...
export const serviceData = [
  {
    ...
    title: "API services",
    description:
      "API services enable seamless communication between applications, allowing data exchange and integration with third-party systems...",
    link: "",
  },
  {
    icon: webIcon,
  ...
  },
  {
    ...
    title: "Back End",
    description:
      "Back-end development focuses on server-side logic, databases, and APIs, ensuring seamless data processing and application functionality...",
    link: "",
  },
];
...
export const toolsData = [mysqlIcon, gitIcon, vscodeIcon];
