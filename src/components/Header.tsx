  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="!m-0">
          <h2 className=" text-[clamp(40px,_8vw,_80px)]">Yago Barbosa</h2>
        </div>
        ...
        <div className="">
          <p className="mt-5">
            Sou desenvolvedor web com foco em back-end, atualmente estou me
            aprimorando para a stack de front-end utilizando React.
          </p>
        </div>
